...
@section('content')
    <section id="hero-area" class="pt-48 pb-10 bg-cover bg-fixed leading-normal tracking-normal bg-img bg-center">
        <div class="container px-6 mx-auto grid">
            <div class="flex items-center justify-center w-full h-full">           
                <div>
                    <div class="text-center">
                        @auth
                        <h2 id="greeting" class="text-4xl font-bold leading-snug text-green-500 mb-1 px-1 py-1 shadow bg-opacity-60 backdrop-blur-sm dark:bg-opacity-70 rounded-xl wow fadeInUp" data-wow-delay="1s">
                        </h2>
                        <h4 class="text-4xl font-semibold lg:block text-gray-50 mb-5 leading-snug wow fadeInUp" data-wow-delay="1s">{{ Auth::user()->name }}</h4>
                        <p class="text-sm xl:text-base mb-8 text-body-color text-white wow fadeInUp" data-wow-delay="1s">
                          Berikan penilaian Anda disini <br> dan Anda dapat melihat hasil penilaian dibawah ini.
                        </p>
                        @endauth   
                    </div>
                        <div class="grid gap-6 mb-8 mt-2 md:grid-cols-2 xl:grid-cols-4">
    ...
    <section class="py-24 dark:bg-gray-900">
        <div class="container">
            <div class="text-center">
                <h4 class="font-semibold text-lg text-primary dark:text-orange-400 mb-2 wow fadeInDown" data-wow-delay="0.3s">
                    Fitur
                </h4>
                <h2 class="mb-12 section-heading dark:text-gray-400 wow fadeInDown" data-wow-delay="0.3s">Fitur Utama Kami</h2>
            </div>
            <div class="flex flex-wrap">
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/3">
                    <div class="m-4 wow fadeInRight" data-wow-delay="0.6s">
                        <div class="icon text-5xl">
                            <i class="far fa-value-absolute dark:text-white"></i>
                        </div>
                        <div>
                            <h3 class="service-title dark:text-green-400">Penilaian</h3>
                            <p class="text-gray-600 dark:text-gray-400">Anda dapat memberikan penilaian tentang lingkungan RT atau lainnya dengan memberikan bintang dan komentar.</p>
                        </div>
                    </div>
                </div>
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/3">
                    <div class="m-4 wow fadeInRight" data-wow-delay="0.6s">
                        <div class="icon text-5xl">
                            <i class="far fa-poll dark:text-white"></i>
                        </div>
                        <div>
                            <h3 class="service-title dark:text-green-400">Hasil Penilaian</h3>
                            <p class="text-gray-600 dark:text-gray-400">Anda dapat melihat hasil penilaian yang telah diberikan dalam bentuk rata-rata dan total yang menilai.</p>
                        </div>
                    </div>
                </div>
                <!-- Services item -->
                <div class="w-full sm:w-1/2 md:w-1/2 lg:w-1/3">
                    <div class="m-4 wow fadeInRight" data-wow-delay="0.9s">
                        <div class="icon text-5xl dark:text-white">
                            <i class="far fa-calendar-alt"></i>
                        </div>
                        <div>
                            <h3 class="service-title dark:text-green-400">Agenda</h3>
                            <p class="text-gray-600 dark:text-gray-400">Anda dapat mengikuti agenda yang kami berikan.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="carousel-area py-32 dark:bg-gray-900">
        <div class="container mx-auto w-full h-full">
            <div class="text-center">
                <h4 class="font-semibold text-lg text-primary dark:text-yellow-400 mb-2 wow fadeInDown" data-wow-delay="0.3s"> 
                    Informasi
                </h4>
                <h2 class="mb-12 section-heading dark:text-gray-400 wow fadeInDown" data-wow-delay="0.3s">Langkah-langkah Memberikan Penilaian</h2>
            </div>
            <div class="relative wrap overflow-hidden p-5 h-full">
            <div class="border-2-2 absolute border-opacity-20 border-gray-700 dark:border-gray-50 h-full border" style="left: 50%"></div>
            ...
            <div class="mb-8 flex justify-between items-center w-full right-timeline">
                ...
                <div class="order-1 bg-white dark:bg-gray-800 rounded-lg shadow-xl w-5/12 px-6 py-4 transform hover:scale-105 transition duration-500 cursor-pointer ease-in-out">
                <h3 class="mb-3 font-bold text-gray-800 dark:text-white text-xl">Mengakses Fitur Penilaian</h3>
                <p class="text-sm leading-snug tracking-wide text-gray-900 dark:text-gray-400 text-opacity-100">Anda dapat mengakses fitur penilaian pada menu "Penilaian" di atas.</p>
                </div>
            </div>
            ...
            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                ...
                <div class="order-1 bg-white dark:bg-gray-800 rounded-lg shadow-xl w-5/12 px-6 py-4 transform hover:scale-105 transition duration-500 cursor-pointer ease-in-out">
                <h3 class="mb-3 font-bold text-gray-800 dark:text-white text-xl">Klik Pada Penilaian yang Tersedia</h3>
                <p class="text-sm font-medium leading-snug tracking-wide text-gray-900 dark:text-gray-400 text-opacity-100">Sebelum melakukan penilaian Anda dapat mengklik pada button seperti panah untuk masuk ke detail penilaian.</p>
                </div>
            </div>
            ...
            <div class="mb-8 flex justify-between items-center w-full right-timeline">
                ...
                <div class="order-1 bg-white dark:bg-gray-800 rounded-lg shadow-xl w-5/12 px-6 py-4 transform hover:scale-105 transition duration-500 cursor-pointer ease-in-out">
                <h3 class="mb-3 font-bold text-gray-800 dark:text-white text-xl">Mengisi Penilaian</h3>
                <p class="text-sm leading-snug tracking-wide text-gray-900 dark:text-gray-400 text-opacity-100">Isi penilaian dengan cara memilih bintang 1 - 5, kemudian menuliskan alasan Anda kenapa memilih rentang bintang tersebut.</p>
                </div>
            </div>
            ...
            <div class="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                ...
                <div class="order-1 bg-white dark:bg-gray-800 rounded-lg shadow-xl w-5/12 px-6 py-4 transform hover:scale-105 transition duration-500 cursor-pointer ease-in-out">
                <h3 class="mb-3 font-bold text-gray-800 dark:text-white text-xl">Berhasil Memberi Penilaian</h3>
                <p class="text-sm font-medium leading-snug tracking-wide text-gray-900 dark:text-gray-400 text-opacity-100">Setelah Anda mengirimkan penilaian dan berhasil, perlu diingat penilaian hanya dapat dilakukan sebanyak satu kali.</p>
                </div>
            </div>
            </div>
        </div>
