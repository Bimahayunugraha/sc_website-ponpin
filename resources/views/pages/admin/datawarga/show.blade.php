...
<main class="h-full pb-16 overflow-y-auto">
    <div class="flex items-center justify-between bg-white px-6 py-3">
        ...
        <div class="inline-flex rounded-md shadow-sm" role="group">
            ...
            <a href="{{ route('datawarga.edit', $user->id) }}"
    ...
    <div class="container px-6 py-6 mx-auto">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Informasi Data Warga</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Detail Data Warga</p>
            </div>
